...
import static base_urls.ManagementonSchoolsBaseUrl.specStudent;
import static base_urls.ManagementonSchoolsBaseUrl.specStudent;
...
public class S02_Put {
    ...
    public void teacherSendsTheStudentInfoData_PUT() {
        ...
        specStudent.pathParams("first", "studentInfo", "second", "save","third",student_info_id);
        ...
        response = given().spec(specStudent).when().body(expectedData).put("{first}/{second}/{third}");
