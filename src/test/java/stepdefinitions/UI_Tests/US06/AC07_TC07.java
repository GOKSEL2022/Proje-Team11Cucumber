...
public class AC07_TC07 {
    ...
    @When("Nilufer Phone alanina {string} girmeyerek bos birakir")
    ...
    @When("Nilufer Ssn alanina tiklar")
    public void kullanici_ssn_alanina_tiklar() {
         deanViceDeanPage.Admin_Vice_Dean_Ssn.click();
    }
    @When("Nilufer Phone alani altinda Required mesajini gorur")
    ...
    @When("Nilufer Phone alani altinda hata mesaji goruntulenmemelidir")
