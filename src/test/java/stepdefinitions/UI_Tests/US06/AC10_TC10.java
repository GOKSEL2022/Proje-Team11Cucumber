...
public class AC10_TC10 {
    ...
    @When("Nilufer Password alanina {string} girmeyerek bos birakir")
    ...
    @When("Nilufer Password alani altinda Required mesajini gorur")
    ...
    @When("Nilufer Password alanina {string} olarak yedi karakter veri girer")
    public void kullanici_password_alanina_olarak_yedi_karakter_veri_girer(String string) {
        deanViceDeanPage.Admin_Vice_Dean_Password.sendKeys(string);
    }
    @When("Nilufer Password alani altinda Minimum {int} character mesajini gorur")
