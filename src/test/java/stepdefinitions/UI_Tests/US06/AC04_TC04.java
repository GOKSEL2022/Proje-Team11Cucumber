...
public class AC04_TC04 {
    ...
    @When("Nilufer Birth Place alanina {string} girmeyerek bos birakir")
    ...
    @When("Nilufer Birth Place alani altinda hata mesaji goruntulenmemelidir")
