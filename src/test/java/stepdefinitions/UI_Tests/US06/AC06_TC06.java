...
public class AC06_TC06 {
    ...
    @When("Kullanici Date Of Birth alanina {string} girmeyerek bos birakir")
    ...
    @When("Kullanici Phone alanina tiklar")
    public void kullanici_phone_alanina_tiklar() {
      deanViceDeanPage.Admin_Vice_Dean_PhoneNumber.click();
    }
    @When("Kullanici Date Of Birth alani altinda Required mesajini gorur")
    ...
    @When("Kullanici Date Of Birth alani altinda hata mesaji goruntulenmemelidir")
