...
public class AC06_TC06 {
    ...
    @When("Nilufer Date Of Birth alanina {string} girmeyerek bos birakir")
    ...
    @When("Nilufer Phone alanina tiklar")
    public void kullanici_phone_alanina_tiklar() {
      deanViceDeanPage.Admin_Vice_Dean_PhoneNumber.click();
    }
    @When("Nilufer Date Of Birth alani altinda Required mesajini gorur")
    ...
    @When("Nilufer Date Of Birth alani altinda hata mesaji goruntulenmemelidir")
