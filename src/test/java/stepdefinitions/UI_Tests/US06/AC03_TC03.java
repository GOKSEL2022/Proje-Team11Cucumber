...
public class AC03_TC03 {
    ...
    @When("Nilufer Surname alanina {string} girmeyerek bos birakir")
    ...
    @When("Nilufer Birth Place alanina tiklar")
    public void kullanici_birth_place_alanina_tiklar() {
        deanViceDeanPage.Admin_Vice_Dean_BirthPlace.click();

    }
    @When("Nilufer Surname alani altinda Required mesajini gorur")
    ...
    @When("Nilufer Surname alani altinda hata mesaji goruntulenmemelidir")
