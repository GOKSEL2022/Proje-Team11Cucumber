...
public class US04_AC08_TC01UserNameBos {
    ...
    @And("Kullanici User Name {string} alanini bos birakir")
    public void kullaniciUserNameAlaniniBosBirakir(String arg0) {
        deanManagementPage.username_Add_Dean.sendKeys(arg0);

    }

    @Then("Kullanici uyari mesaji Required gorur")
    public void kullaniciUyariMesajiRequiredGorur() {
