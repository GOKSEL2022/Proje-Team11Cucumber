...
public class US04_AC09_TC01PasswordBos {
    ...
    @And("Kullanici password {string} alanini bos birakir")
    public void kullaniciPasswordAlaniniBosBirakir(String arg0) {
        deanManagementPage.password_Add_Dean.sendKeys(arg0);
    }

    @Then("Kullanici Required uyari mesajini alir")
    public void kullaniciRequiredUyariMesajiniAlir() {
