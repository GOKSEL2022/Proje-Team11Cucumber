...
public class US04_AC06_TC02Phone11karakterVeriGir {
    ...
    @And("Kullanici Phone {string} alanina istenilen onbir karakter veri girer")
    public void kullaniciPhoneAlaninaIstenilenOnbirKarakterVeriGirer(String arg0) {
        deanManagementPage.phoneNumber_Add_Dean.sendKeys(arg0);
    }

    @Then("Kullanici karakter uyari mesaji gorur")
    public void kullaniciKarakterUyariMesajiGorur() {
