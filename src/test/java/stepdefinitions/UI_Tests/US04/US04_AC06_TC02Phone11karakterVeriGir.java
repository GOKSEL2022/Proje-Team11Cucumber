...
public class US04_AC06_TC02Phone11karakterVeriGir {
    ...
    @And("Alı Phone {string} alanina istenilen onbir karakter veri girer")
    public void AlıPhoneAlaninaIstenilenOnbirKarakterVeriGirer(String arg0) {
        deanManagementPage.phoneNumber_Add_Dean.sendKeys(arg0);
    }

    @Then("Alı karakter uyari mesaji gorur")
    public void AlıKarakterUyariMesajiGorur() {
