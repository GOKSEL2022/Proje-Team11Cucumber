...
public class US04_AC07_TC02SsaAlanina12RakamGir {
    ...
    @And("Kullanici Ssn {string} alanina oniki karakter veri girer")
    public void kullaniciSsnAlaninaOnikiKarakterVeriGirer(String arg0) {
        deanManagementPage.ssn_Add_Dean.sendKeys(arg0);
    }

    @Then("Kullanici textboxin altinda uyari mesjini gorur")
    public void kullaniciTextboxinAltindaUyariMesjiniGorur() {
