...
public class AC07_TC07 {
    ...
    @When("Nilufer Phone alanina {string} girmeyerek bos birak")
    ...
    @When("Nilufer Ssn alanina tikla")
    public void ssn_alanina_tikla() {
        adminViceDeanPage.Admin_Vice_Dean_Ssn.click();
    }
    @When("Nilufer Phone alani altinda Required mesajini gor")
    ...
    @When("Nilufer Phone alani altinda hata mesaji goruntulenmemeli")
