...
public class AC10_TC10 {
    ...
    @When("Password alanina {string} girmeyerek bos birak")
    ...
    @When("Password alani altinda Required mesajini gor")
    ...
    @When("Password alanina {string} olarak yedi karakter veri gir")
    public void password_alanina_olarak_yedi_karakter_veri_gir(String string) {
        adminViceDeanPage.Admin_Vice_Dean_Password.sendKeys(string);
    }
    @When("Password alani altinda Minimum {int} character mesajini gor")
