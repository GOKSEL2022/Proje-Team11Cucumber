@US05_AC03_TC26 @team11
Feature:Dean ekleyebilme

  Scenario Outline:AC03_TC10_password_Alani_Guncelle
    ...
    And Kullanıcı bır sanıye bekler
    And Kullanici password alanini siler.
    And Kullanıcı password alanina 7 karakter veri girer.
    And Kullanıcı bır sanıye bekler
