@admin @goksel @team11Regression @goksel
Feature:US01
  Scenario Outline:US01
    ...
    And   Goksel bir sn bekler
    And   Goksel Date Of Birt "<Date Of Birt>" ayni gün girer
    And   Goksel bir sn bekler
    ...
    Examples:
      ...
      | Admin44444 | Celik44 | Ordu        | 452-481-2166 | 10.05.2023   | 419-78-1273  | Goksel Celik4444 | 12345678 |
