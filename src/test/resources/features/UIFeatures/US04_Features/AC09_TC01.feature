@US04_AC09_TC01 @team11 @team11Regression
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Ali bır sanıye bekler
    And Ali password "<password>" alanini bos birakir
    And Ali bır sanıye bekler
...
#
    Examples: dean_bilgileri
      ...
      | Admin      | 485424698 | hasan | tarik    | Van         | 29-03-2001    | 090-505-8204  | 505-41-6328  |Team11     |          |