...
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Kullanıcı bır sanıye bekler
    And Kullanici password "<password>" alanini bos birakir
    And Kullanıcı bır sanıye bekler
...
#
    Examples: dean_bilgileri
      ...
      | karakartal | 987654321 | hasan | tarik    | Van         | 29-03-2001    | 090-505-8204  | 505-41-6328  |Team11     |          |