@US04_AC08_TC01 @team11 @team11Regression
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Ali bır sanıye bekler
    And Ali User Name "<User Name>" alanini bos birakir
    And Ali bır sanıye bekler
...
#
    Examples: dean_bilgileri
      ...
      | Admin      | 485424698 | hasan | tarik    | Van         | 29-03-2001    | 090-505-8203  | 505-41-6328  |           | 57916929 |