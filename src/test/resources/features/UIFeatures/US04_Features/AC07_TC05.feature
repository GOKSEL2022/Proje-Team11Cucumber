...
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Kullanıcı bır sanıye bekler
    And Kullanici Ssn "<Ssn>" alanina dokuz karakter veri girer
    And Kullanıcı bır sanıye bekler
...
#
    Examples: dean_bilgileri
      ...
      | karakartal | 987654321 | hasan | tarik    | Van         | 29-03-2001    | 090-505-8202  | 123456789    |Team11     | 57916929 |