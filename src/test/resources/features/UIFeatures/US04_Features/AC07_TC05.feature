@US04_AC07_TC05 @team11 @team11Regression
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Ali bır sanıye bekler
    And Ali Ssn "<Ssn>" alanina dokuz karakter veri girer
    And Ali bır sanıye bekler
...
#
    Examples: dean_bilgileri
      ...
      | Admin      | 485424698 | hasan | tarik    | Van         | 29-03-2001    | 090-505-8202  | 123456789    |Team11     | 57916929 |