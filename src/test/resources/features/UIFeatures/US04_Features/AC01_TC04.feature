...
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Kullanıcı bır sanıye bekler
    And Kullanici Name "<Name>" alanina rakam girer
    And Kullanıcı bır sanıye bekler
...
#
    Examples: dean_bilgileri
      ...
      | karakartal | 987654321 | 1234  | tarik    | Van         | 29-03-2001    | 090-505-8187  | 505-71-6328  |Team11     | 57916929 |