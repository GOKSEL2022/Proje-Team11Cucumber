@US04_AC06_TC01 @team11 @team11Regression
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Ali bır sanıye bekler
    And Ali Phone "<Phone>" alanina istenilen formatta veri girer
    And Ali bır sanıye bekler
...
#
    Examples: dean_bilgileri
      ...
      | Admin      | 485424698 | hasan | tarik    | Van         | 29-03-2001    |         | 505-41-6328  |Team11     | 57916929 |