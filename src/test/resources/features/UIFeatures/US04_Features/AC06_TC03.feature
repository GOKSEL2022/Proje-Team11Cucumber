@US04_AC06_TC03 @team11 @team11Regression
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Ali bır sanıye bekler
    And Ali Phone "<Phone>" alanina onuc karakter veri girer
    And Ali bır sanıye bekler
    ...
    And Ali bır sanıye bekler
    Then Ali sayfada  Phone number should be exact 12 characters mesaji Alir
    Then close the application
#
    Examples: dean_bilgileri
      | Username  | Password   | Name  | Surname  | Birth Place | Date Of Birth | Phone         | Ssn          | User Name | password |
      | Admin      | 485424698 | hasan | tarik    | Van         | 29-03-2001    | 023-525-82856 | 505-41-6328  |Team11     | 57916929 |