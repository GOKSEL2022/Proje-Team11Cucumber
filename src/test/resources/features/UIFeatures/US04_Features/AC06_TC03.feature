...
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Kullanıcı bır sanıye bekler
    And Kullanici Phone "<Phone>" alanina onuc karakter veri girer
    And Kullanıcı bır sanıye bekler
    ...
    And Kullanıcı bır sanıye bekler
    Then Kullanici sayfada  Phone number should be exact 12 characters mesaji alir
#
    Examples: dean_bilgileri
      | Username  | Password   | Name  | Surname  | Birth Place | Date Of Birth | Phone         | Ssn          | User Name | password |
      | karakartal | 987654321 | hasan | tarik    | Van         | 29-03-2001    | 023-525-82856 | 505-41-6328  |Team11     | 57916929 |