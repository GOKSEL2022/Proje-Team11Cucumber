@US04_AC02_TC02 @team11Regression @team11 @admin
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Ali bır sanıye bekler
    And Ali Surname "<Surname>" alanina sembol girer
    And Ali bır sanıye bekler
...
#
    Examples: dean_bilgileri
      ...
      | Admin      | 485424698 | hasan | -----    | Van         | 29-03-2001    | 090-505-8190  | 505-41-6328  |Team11     | 57916929 |