@US04_AC09_TC02 @team11 @team11Regression
Feature:Dean ekleyebilme
  ...
  Scenario Outline: TC01_Dean_olustur
    ...
    And Ali bır sanıye bekler
    And Ali password "<password>" alanina yedi karakter sifre girer
    And Ali bır sanıye bekler
    When Ali Submit butonuna tiklar
    And Ali bır sanıye bekler
    Then Ali altta uyari mesaji gorur.
    Then close the application
#
    Examples: dean_bilgileri
      | Username  | Password   | Name  | Surname  | Birth Place | Date Of Birth | Phone         | Ssn          | User Name | password |
      | Admin      | 485424698 | hasan | tarik    | Van         | 29-03-2001    | 090-505-8205  | 505-41-6328  |Team11     | 9876543  |